...
class SpotifyDB:
    ...
    def ban_artist(self, artist:Artist):
        self.cursor.execute(self, self.CMD_SQL_BAN_ARTIST, (artist.name,artist.id))
    ...
    def create_artist_table(self) -> None:
        ...
        if self.check_artist_table(self.cursor) is False:
    ...
    def create_track_table(self) -> None:
        ...
        if self.check_track_table(self.cursor) is False:
